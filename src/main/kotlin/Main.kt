...
enum class KTXTicket(
    ...
    DONGDEAGU_TO_SEOUL_FIRST("동대구에서 서울", 1400, 1700, DONGDAEGO_TO_SEOUL_FIRST, true),
    DONGDEAGU_TO_SEOUL_SECOND("동대구에서 서울", 1400, 1700, DONGDAEGO_TO_SEOUL_SECOND, true),
    DONGDEAGU_TO_SEOUL_THIRD("동대구에서 서울", 1400, 1700, DONGDAEGO_TO_SEOUL_THIRD, true),
